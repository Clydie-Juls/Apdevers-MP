...
const ProfileSide = ({
  ...
  return (
    <div className="w-[35ch] min-h-100 p-5 flex flex-col items-stretch gap-8 border-2 border-border rounded-xl bg-zinc-950">
      <div className="flex flex-col gap-2 items-center">
        <Avatar
          className={
            "relative min-h-40 min-w-40 " +
            (showUserButtons && " cursor-pointer")
          }
      ...
      <div className="mt-1 flex flex-col justify-center gap-3">
        {showUserButtons && (
          <>
            ...
            <Button variant="destructive" onClick={setShowDeleteModal}>
              Delete Profile
            </Button>
          </>
        )}
